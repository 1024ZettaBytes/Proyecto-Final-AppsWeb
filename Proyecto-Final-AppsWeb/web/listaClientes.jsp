<%-- 
    ...
    Created on : 30/11/2018, 03:57:01 PM
    Author     : mario
--%>
            ...
            <table data-vertable="ver2">
                <thead>
                    <tr class="row100 head">
                        <th class="column100 column1" data-column="column1">Credencial</th>
                        <th class="column100 column2" data-column="column2">Nombre</th>
                        <th class="column100 column3" data-column="column3">Direccion</th>
                        <th class="column100 column4" data-column="column4">Teléfono</th>                           
                    </tr>
                </thead>
                <tbody>
                    <%

                        List listaClientes = (List) request.getAttribute("listaClientes");
                        for (int i = 0; i < listaClientes.size(); i++) {
                            ...
                            out.println("<td class='column100 column1' data-column='column1'>" + c.getNombre() + "</td>");
                            out.println("<td class='column100 column1' data-column='column1'>" + c.getDireccion() + "</td>");
                            out.println("<td class='column100 column1' data-column='column1'>" + c.getTelefono() + "</td>");
                            out.println("</tr>");
