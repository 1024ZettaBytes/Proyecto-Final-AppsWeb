<%-- 
    Document   : consultaRentasCliente
    Created on : 6/12/2018, 12:45:49 AM
...
<html>
    <head>
        ...
        <title>Consultar Rentas de Cliente</title>
    ...
    <body>
        ...
        <div class="contenido">
            <h1>Consultar Rentas de Cliente</h1>
            <div class="form-style-8">
                ...
                <form action="operacionesRentas" >
                    ...
                    <input type="submit" value="Consultar Rentas" name="tarea"/>
                </form>
            </div>
        </div>
    </body>
