<%-- 
    ...
    Created on : 3/12/2018, 06:56:55 PM
    Author     : mario
--%>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="contenido">
            ...
            <div class="form-style-8">
                <h2>Ingresa la credencial del cliente a eliminar</h2>
                <form action="operacionesClientes">
                    <input type="text" name="credencial" placeholder="Ingresa el numero de credencial" required /><br/>
                    <input type="submit" name="tarea" value="Eliminar Cliente"/>
                </form>
            </div>
        </div>
    </body>
