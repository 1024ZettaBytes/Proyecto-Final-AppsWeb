<%-- 
    ...
    Created on : 5/12/2018, 03:12:03 PM
    Author     : mario
--%>
...
<html>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="contenido">
            <h1>Elimina inventario</h1>
            <div class="form-style-8">
                <h2>Ingresa los datos del videojuego a eliminar</h2>
                <form action="operacionesInventario">
                    <input type="text" placeholder="Número de catálogo" name="numCatalogo" required=""/><br/>
                    <input name="cantidad" min="1" placeholder="Cantidad" type="number" onkeypress="return isNumberKey(event)" required/><br>
                    <input type="submit" name="tarea" value="Desinventariar"/>
                </form>
            </div>
        </div>
    </body>
