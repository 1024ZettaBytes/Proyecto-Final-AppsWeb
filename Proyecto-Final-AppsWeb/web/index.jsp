<%-- 
    Document   : index
    Created on : 6/12/2018, 07:15:10 AM
...
<html>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="contenido">
            <h1>Seleccione una de las opciones del menú</h1>
            <br><br>
            <img src="imgs/logo.png" width="512px" alt="Logo"/>   
            <p>Por:<br>
                Ariel Aramburo Barraza <br>
                Jesus Eduardo Ramírez Cota<br>
                Mario Alejandro Leyva Gil<br>
