<%-- 
    Document   : devolverVideojuego
    Created on : 5/12/2018, 08:43:02 PM
...
<html>
    ...
    <body>
        ...
        <div class="contenido">
            <h1>Devolver un videojuego</h1>
            <div class="form-style-8">

                <h2>Ingresa los datos de la renta</h2>
                <form action="operacionesRentas" >
                    ...
                    <input type="submit" value="Devolver" name="tarea"/>
                </form>
            </div>
        </div>
