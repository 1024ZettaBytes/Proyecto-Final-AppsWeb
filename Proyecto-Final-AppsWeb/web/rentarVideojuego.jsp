<%-- 
    Document   : rentarVideojuego
    Created on : 5/12/2018, 05:44:16 PM
...
<html>
    ...
    <body>
        ...
        <nav>
            ...
            <div class="contenido">
            <h1>Rentar Videojuego</h1>
            <div class="form-style-8">
                <h2>Ingresa la información</h2>
                <form action="operacionesRentas" >
                    <input type="text" placeholder="Credencial cliente" name="cred" required /><br>
            <input type="text" placeholder="Catálago de videojuego" name="catalago" required /><br>
            
            
            <input name="tiempo" min="1" placeholder="Tiempo de renta(días)" type="number" onkeypress="return isNumberKey(event)" required/><br>

            <input type="submit" value="Rentar" name="tarea"/>
                </form>
            </div>
        </div>
