       ...
       <nav>
        ...
        <div class="contenido">
            ...
            <div class="form-style-8">
                <h2>Ingresa los datos del videojuego a agregar</h2>
                <form action="operacionesVideojuegos">
                    <input type="text" name="numeroDeCatalogo" placeholder="Numero de catalago" required/><br/>
                    <input type="text" name="titulo" placeholder="Titulo" required/><br/>
                    <input type="text" name="genero" placeholder="Género" required/><br/>
                    <input type="text" name="clasificacion" placeholder="Clasificación" required/><br/>
                    <input type="text" name="consola" placeholder="Consola" required/><br/>
                    <input type="text" name="fabricante" placeholder="Fabricante" required/><br/>
                    <input name="version" min="0" placeholder="Versión" type="number" onkeypress="return isNumberKey(event)" required/><br>
                    <input type="submit" name ="tarea" value="Agregar Videojuego">
                </form>
            </div>
        </div>
    </body>
