<%-- 
    Document   : consultaRentasPeriodo
    Created on : 6/12/2018, 01:09:01 AM
...
<html>
    <head>
        ...
        <title>Consultar Rentas Por Periodo</title>
    ...
    <body>
       <nav>
        ...
        <div class="contenido">
            ...
            <h1>Búsqueda por periodo</h1>
            <div class="form-style-8">
                <h2>Seleccione el periodo</h2>
                <form action="operacionesRentas" >
                    <input type="date"  name="desde" placeholder="Desde" required/><br>
                    <input type="date"  name="hasta" placeholder="Hasta" required /><br>
                    <input type="submit" value="Consultar Periodo" name="tarea"/>
                </form>
            </div>
        </div>
    </body>
