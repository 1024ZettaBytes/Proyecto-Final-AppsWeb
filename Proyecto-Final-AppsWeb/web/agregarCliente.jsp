<%-- 
    ...
    Created on : 25/11/2018, 03:16:31 PM
    Author     : mario
--%>
        ...
        <div class="contenido">
            ...
            <div class="form-style-8">
                ...
                <form action="operacionesClientes" >
                    <input type="text" placeholder="Credencial" name="cred" required /><br>
                    ...
                    <input type="text" maxlength="10" placeholder="Teléfono" onkeypress="return isNumberKey(event)" name="telefono" required /><br>
                    <input type="submit" value="Guardar" name="tarea"/>
                </form>
            </div>
        </div>
            </body>
