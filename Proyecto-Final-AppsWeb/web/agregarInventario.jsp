<%-- 
    ...
    Created on : 5/12/2018, 02:54:09 PM
    Author     : mario
--%>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="contenido">
            ...
            <div class="form-style-8">
                <h2>Ingresa el videojuego a inventariar</h2>
                <form action="operacionesInventario">
                    <input type="text" name="numCatalogo" placeholder="Número de catálogo" required/><br/>
                    
                    <input name="cantidad" min="1" placeholder="Cantidad" type="number" onkeypress="return isNumberKey(event)" required/><br>
                    <input type="submit" name="tarea" value="Agregar Inventario"/>
                </form>
            </div>
        </div>
